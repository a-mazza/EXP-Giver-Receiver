...
data(contains(data.Slide, 'INTRO_OK'),:) = [];
...
events = find(dat.Event == 1);


    for i = 1:length(events)
        trial = dat(events(i)+1:events(i)+2500,[6 7 9]); % +2500 <-- from 0 (trial change, i.e. start countdown) to +2500 samples (i.e. 5 sconds i.e. end countdouwn)
